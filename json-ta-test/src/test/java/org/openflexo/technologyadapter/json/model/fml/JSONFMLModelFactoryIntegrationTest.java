...
package org.openflexo.technologyadapter.json.model.fml;
...
public class JSONFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(JSONFMLModelFactoryIntegrationTest.class.getPackage().getName());
	...
	public void checkXXFMLTechnologyAdapter() {
		...
		testVirtualModelModelFactoryWithTechnologyAdapter(
				serviceManager.getTechnologyAdapterService().getTechnologyAdapter(JSONTechnologyAdapter.class));
	}
